...
import RecentFavs from "./recent-favs/recent-favs.js";
    ...
    <Container>
      ...
      <InputGroup className="m-auto searchbar-group" size="lg">
        ...
        <Form.Control
          ...
          onKeyUp={(e) => {
            if (e.key === "Enter") {
              searchSummonerEvent(selectedRegion.server, summonerName);
            }
          }}
        ...
        <ListGroup className="m-auto recent-searches mt-2">
          ...
          {recentSearches.map((recentSearch) => (
            <ListGroup.Item
              ...
              onClick={() =>
                searchSummonerEvent(recentSearch.region, recentSearch.name)
              }
            >
              <span>
                <Image
              ...
              <span
                ...
                style={{
                  backgroundColor: regions.find(
                    (region) => region.server === recentSearch.region
                  ).color,
                }}
              >
                {
          ...
          <div className="text-center">
            {regions.map((region) => (
              <Button
                ...
                style={{
                  backgroundColor:
                    region === selectedRegion ? region.color : "#464264",
                }}
